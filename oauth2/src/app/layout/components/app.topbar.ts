...
import { AuthStateService } from 'common-lib/src/lib/services/auth-state.service';
import { StorageKeys } from 'common-lib/src/lib/constants/constant';
import { AuthService } from '@/services/auth.service';
import { NotificationService } from 'common-lib/src/lib/services/notification.service';
                ...
                <li class="profile-item static sm:relative">
                    ...
                    >
                        <ul class="flex flex-col gap-1">
                            ...
                            <li>
                                <a (click)="signOut()" class="label-small dark:text-surface-400 flex gap-2 py-2 px-2.5 rounded-lg items-center hover:bg-emphasis transition-colors duration-150 cursor-pointer">
